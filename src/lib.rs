...
pub use settings::{
    AlertSound, InactivityBehavior, Settings, TimerCheckpoint, TimerShape, WidgetSize,
...
pub use view::{
    ...
    pill_background_rgb, play_center, progress, state_label, status_word, tag_goal,
    timer_render_key, widget_layout, widget_pixel_size, Hit, TimerRenderKey, WidgetLayout,
    WIDGET_H, WIDGET_W,
};
